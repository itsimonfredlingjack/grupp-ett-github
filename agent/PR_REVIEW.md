...
The `AdminAuthService` uses hardcoded credentials (`[REDACTED]` / `[REDACTED]`) in the source code. This is a severe security risk as these credentials are exposed in the repository.

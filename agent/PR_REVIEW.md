...
The `tests/newsflash/test_color_scheme.py` file contains an unused helper method `extract_hex_color` which is not referenced by any tests in the suite.
**Action:** Remove the unused method or update tests to use it.

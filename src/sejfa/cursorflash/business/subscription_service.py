"""Business logic for subscription handling.
...
class SubscriptionService:
    """Service for validating and processing subscriptions.
    ...
    def process_subscription(self, email: str, name: str) -> dict[str, Any]:
        ...
        from src.sejfa.cursorflash.business.service import ValidationError
